                    ...
                    <div class="col-md-3 arrival-grid simpleCart_shelfItem">
                        <div class="grid-arr">
                            ...
                            <div class="women">
                                ...
                                <p ><del>TK.{{ $product->regular_price }}</del><em class="item_price">TK.{{ $product->selling_price }}</em></p>
                                <a href="{{ url('/direct-add-cart/'.$product->id) }}" data-text="Add To Cart" class="my-cart-b item_add">Add To Cart</a>
                            </div>
                        </div>
                    </div>
                    @endforeach
