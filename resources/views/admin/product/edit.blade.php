...
@section('content')
    ...
    <div class="container-fluid" style="border-radius: 20px; background: rgba(1,0,0,0.5); color: white;">
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="well">
                    <form name="productEditForm" action="{{ '/update-product' }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="regular_price" value="{{ $product->regular_price }}" required/>
                        ...
                        <div class="form-group">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="product_discount" value="{{ $product->product_discount }}" required/>
                        ...
                        <div class="form-group">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" rows="5" name="product_short_description" required>{{ $product->product_short_description }}</textarea>
                        ...
                        <div class="form-group">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" rows="15" name="product_long_description" required>{{ $product->product_long_description }}</textarea>
